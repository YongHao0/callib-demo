...
// var tBarInvite = tools.getDom('.rong-invite')[0];
...
// function invite() {
//   var otherIds = params.otherIds;
//   params.mediaType = mediaType;
//   if (otherIds.length) {
//     params.inviteUserIds = otherIds;
//     RongCallLib.invite(params, function (err) {
//     });
//   } else {
//     alert('已邀请所有人');
//   }
